...
using Projeto2ApiCatalogoJogos.Exceptions;
using Projeto2ApiCatalogoJogos.InputModel;
using Projeto2ApiCatalogoJogos.Services;
using System;
...
namespace Projeto2ApiCatalogoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        /// </summary>
        /// <remarks>
        /// Id invalido retorna um erro
        /// </remarks>
        /// <param name="idJogo">Id do jogo buscado</param>
        /// <response code="200">Retorna o jogo filtrado</response>
        /// <response code="204">Caso não haja jogo com este id</response>
        [HttpGet("{idJogo:guid}")]
        public async Task<ActionResult<JogoInputModel>> Obter(Guid idJogo)
        {
        ...
        /// </summary>
        /// <remarks>
        /// Preencher todas os campos para um registro correto
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Verbo Put altera todos os campos do registro
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Verbo Patch altera apenas campos pré-selecionados do registro
        /// </remarks>
        /// <param name="idJogo">Id do jogo a ser atualizado</param>
        ...
        public async Task<ActionResult> AtualizarNomeJogo([FromRoute] Guid idJogo, [FromRoute] string nome)
        {
            try
            {
                await _jogoService.AtualizarNome(idJogo, nome);
        ...
        /// </summary>
        /// <remarks>
        /// Deleta o jogo com base no Id
        /// </remarks>
        /// <param name="idJogo">Id do jogo a ser excluído</param>
        /// <response code="200">Caso o jogo seja deletado com sucesso</response>
        /// <response code="404">Caso não exista um jogo com este Id</response>
